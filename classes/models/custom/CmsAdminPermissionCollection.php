 ...
 */
class CmsAdminPermissionCollection extends DinklyDataCollection
{
	public static function getByArrayOfIds($db = null, $perm_ids)
	{
		$peer_object = new CmsAdminPermission();

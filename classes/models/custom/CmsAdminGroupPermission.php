 ...
 */
class CmsAdminGroupPermission extends BaseCmsAdminGroupPermission
{
	public function initWithGroupAndPermission($group_id, $permission_id)
	{
		...
		$query = $this->getSelectQuery() . " where permission_id=" . $this->db->quote($permission_id) 

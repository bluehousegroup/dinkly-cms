		...
		<div class="content-wrapper has-header">
			...
			<div class="content-header clearfix">
				...
				<div class="pull-right">
					<a href="/site_admin/blog" class="btn">New Post</a>
			...
			<div class="content-body scrollable">
						...
						<ul class="nav nav-pills nav-stacked">
							<?php if(isset($posts) AND count($posts) > 0): ?>
								<?php foreach($posts as $post): ?>
									<li><a href="/site_admin/blog/edit/post/<?php echo $post->getId(); ?>"><?php echo $post->getPostTitle(); ?></a></li>
								<?php endforeach; ?>
							<?php endif; ?>
						</ul>
					</div>
				...
				<form id="blog-form" class="editor-form form-horizontal" action="/site_admin/blog/save" method="post" enctype="multipart/form-data">
					...
					<div class="content-editor-actions">
						<div class="pad">
							...
							<a href="/site_admin/blog" class="btn">Discard Changes</a>
							<a onclick="return confirm('Are you super sure?');" href="/site_admin/blog/delete/post/<?php if(isset($edit_post)) echo $edit_post->getId(); ?>" class="btn btn-danger pull-right">Delete Post</a>
						</div>
					</div>

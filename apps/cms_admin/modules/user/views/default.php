		...
		<div class="content-wrapper has-header">
			...
			<div class="content-header clearfix">
				...
				<div class="btn-group pull-right">
					<a class="btn btn-primary" href="/cms_admin/user/new">Create New User</a>
				</div>
			</div>
			<div class="content-body">
				<div class="results-actions">
					<div class="pad">
						<?php include_once('../apps/cms_admin/layout/filters.php'); ?>
					</div>
				</div>
						...
						<table class="table dataTables table-striped table-bordered" id="user-list">
							...
							<tbody>
								<?php if($users): ?>
									...
									<tr>
										<td><a href="/cms_admin/user/view/id/<?php echo $user->getId(); ?>"><?php echo $user->getUsername(); ?></a></td>
